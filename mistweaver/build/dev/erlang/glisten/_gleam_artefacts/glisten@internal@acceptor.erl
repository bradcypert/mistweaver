...
-type pool(KWI, KWJ) :: {pool,
        fun((KWI, glisten@internal@handler:loop_message(KWJ), glisten@internal@handler:connection(KWJ)) -> glisten@internal@handler:next(KWI, glisten@internal@handler:loop_message(KWJ))),
        integer(),
        gleam@erlang@process:name(gleam@otp@factory_supervisor:message(glisten@socket:socket(), gleam@erlang@process:subject(glisten@internal@handler:message(KWJ)))),
        fun((glisten@internal@handler:connection(KWJ)) -> {KWI,
            gleam@option:option(gleam@erlang@process:selector(KWJ))}),
        gleam@option:option(fun((KWI) -> nil)),
        glisten@transport:transport(),
...
-spec start(
    ...
    gleam@erlang@process:name(gleam@otp@factory_supervisor:message(glisten@socket:socket(), gleam@erlang@process:subject(glisten@internal@handler:message(KWL))))
) -> {ok,
