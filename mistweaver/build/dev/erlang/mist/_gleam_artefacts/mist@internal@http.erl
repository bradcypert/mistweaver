...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(PZT)) -> gleam@http@response:response(PZT).
...
?DOC(false).
-spec add_date_header(gleam@http@response:response(PZK)) -> gleam@http@response:response(PZK).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(PZN)) -> gleam@http@response:response(PZN).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(PZQ)) -> gleam@http@response:response(PZQ).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(PZY)) -> gleam@http@response:response(PZY)).
