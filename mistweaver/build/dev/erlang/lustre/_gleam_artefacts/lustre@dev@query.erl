...
-spec find_matching_in_list(
    list(lustre@vdom@vnode:element(IFN)),
    selector(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(IFN), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_direct_child(
    ...
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(IFI), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_descendant_in_list(
    list(lustre@vdom@vnode:element(IFY)),
    selector(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(IFY), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_descendant(
    lustre@vdom@vnode:element(IFT),
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(IFT), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_in_list(
    ...
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(IFC), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_in_children(
    ...
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(IEX), lustre@vdom@path:path()}} |
    {error, nil}.
...
?DOC(false).
-spec find_path(
    lustre@vdom@vnode:element(IES),
    'query'(),
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(IES), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find(lustre@vdom@vnode:element(IEN), 'query'()) -> {ok,
        lustre@vdom@vnode:element(IEN)} |
    {error, nil}.
find(Root, Query) ->
...
-spec find_all_matching_in_list(
    list(lustre@vdom@vnode:element(IGV)),
    selector()
) -> list(lustre@vdom@vnode:element(IGV)).
...
-spec find_all_direct_children(lustre@vdom@vnode:element(IGR), selector()) -> list(lustre@vdom@vnode:element(IGR)).
...
-spec find_all_descendants(lustre@vdom@vnode:element(IHA), selector()) -> list(lustre@vdom@vnode:element(IHA)).
...
-spec find_all_in_list(list(lustre@vdom@vnode:element(IGM)), 'query'()) -> list(lustre@vdom@vnode:element(IGM)).
...
-spec find_all_in_children(lustre@vdom@vnode:element(IGI), 'query'()) -> list(lustre@vdom@vnode:element(IGI)).
...
-spec find_all(lustre@vdom@vnode:element(IGE), 'query'()) -> list(lustre@vdom@vnode:element(IGE)).
find_all(Root, Query) ->
    case Query of
        {find_element, Selector} ->
            case matches(Root, Selector) of
