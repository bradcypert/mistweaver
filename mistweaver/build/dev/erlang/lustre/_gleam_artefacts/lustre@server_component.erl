...
-spec element(
    list(lustre@vdom@vattr:attribute(KLV)),
    list(lustre@vdom@vnode:element(KLV))
) -> lustre@vdom@vnode:element(KLV).
...
-spec include(lustre@vdom@vattr:attribute(KMH), list(binary())) -> lustre@vdom@vattr:attribute(KMH).
...
-spec subject(lustre:runtime(KMN)) -> gleam@erlang@process:subject(lustre@runtime@server@runtime:message(KMN)).
subject(Runtime) ->
...
-spec register_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(KMV))
) -> lustre@runtime@server@runtime:message(KMV).
...
-spec deregister_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(KMZ))
) -> lustre@runtime@server@runtime:message(KMZ).
...
-spec register_callback(
    fun((lustre@runtime@transport:client_message(KND)) -> nil)
) -> lustre@runtime@server@runtime:message(KND).
...
-spec deregister_callback(
    fun((lustre@runtime@transport:client_message(KNG)) -> nil)
) -> lustre@runtime@server@runtime:message(KNG).
...
-spec select(
    fun((fun((KNL) -> nil), gleam@erlang@process:subject(any())) -> gleam@erlang@process:selector(KNL))
) -> lustre@effect:effect(KNL).
select(Sel) ->
