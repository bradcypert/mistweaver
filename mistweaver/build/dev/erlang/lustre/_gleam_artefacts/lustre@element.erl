...
-spec element(
    binary(),
    list(lustre@vdom@vattr:attribute(CSS)),
    list(lustre@vdom@vnode:element(CSS))
) -> lustre@vdom@vnode:element(CSS).
...
-spec namespaced(
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(CSY)),
    list(lustre@vdom@vnode:element(CSY))
) -> lustre@vdom@vnode:element(CSY).
...
-spec advanced(
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(CTE)),
    list(lustre@vdom@vnode:element(CTE)),
    boolean(),
    boolean()
) -> lustre@vdom@vnode:element(CTE).
...
-spec fragment(list(lustre@vdom@vnode:element(CTO))) -> lustre@vdom@vnode:element(CTO).
fragment(Children) ->
...
-spec unsafe_raw_html(
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(CTS)),
    binary()
) -> lustre@vdom@vnode:element(CTS).
...
-spec memo(
    ...
    fun(() -> lustre@vdom@vnode:element(CTX))
) -> lustre@vdom@vnode:element(CTX).
...
-spec map(lustre@vdom@vnode:element(CUB), fun((CUB) -> CUD)) -> lustre@vdom@vnode:element(CUD).
map(Element, F) ->
...
-spec wrap_document(lustre@vdom@vnode:element(CUP)) -> lustre@vdom@vnode:element(CUP).
wrap_document(El) ->
