...
-type client_message(EHU) :: {mount,
        ...
        lustre@vdom@vnode:element(EHU),
        lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(EHU)), lustre@vdom@vnode:element(EHU))} |
    {reconcile,
        integer(),
        lustre@vdom@patch:patch(EHU),
        lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(EHU)), lustre@vdom@vnode:element(EHU))} |
...
-spec mount(
    ...
    list(binary()),
    gleam@dict:dict(binary(), gleam@json:json()),
    lustre@vdom@vnode:element(EIA),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(EIA)), lustre@vdom@vnode:element(EIA))
) -> client_message(EIA).
mount(
    Open_shadow_root,
    Will_adopt_styles,
...
?DOC(false).
-spec reconcile(
    lustre@vdom@patch:patch(EIE),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(EIE)), lustre@vdom@vnode:element(EIE))
) -> client_message(EIE).
...
-spec reconcile_to_json(
    integer(),
    lustre@vdom@patch:patch(EJB),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(EJB)), lustre@vdom@vnode:element(EJB))
) -> gleam@json:json().
...
-spec mount_to_json(
    ...
    list(binary()),
    gleam@dict:dict(binary(), gleam@json:json()),
    lustre@vdom@vnode:element(EIY),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(EIY)), lustre@vdom@vnode:element(EIY))
) -> gleam@json:json().
mount_to_json(
    Kind,
    Open_shadow_root,
